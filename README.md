...
## Lisa/muuda sissekandeid
Kõik loodud sissekanded on esitatud tabeli kujul. Neid on võimalik sorteerida projekti nime, kestvuse ja kuupäeva järgi. Tabelist paremal asuvad nupud sissekannete lisamiseks, muutmiseks ja kustutamiseks. Kustutamiseks või muutmiseks tuleb kõigepealt tabelis vastav sissekanne aktiivseks teha.
## Statistika
Statistika jaguneb omakorda kolmeks osaks:
* Projektid
* Progress
* Eesmärgid
...
### Progress
Kasutajale kuvatakse joondiagrammi abil igale projektile kulutatud aeg minutites päevade kaupa. 
### Eesmärgid
Kõigepealt tuleb valida projekt, mille kohta statistikat näha tahetakse. Seejärel kuvatakse kasutajale graafiliselt, kui kaugel ta mingi eesmärgi täitmisest on. Koguaeg arvestatakse 4 eesmärgi täitmist: 10, 100, 1000 ja 10 000 tundi. Eesmärgi täitumisel alustatakse sellega otsast peale järgmises ajavahemikus. Näiteks esimese 10 tunni täitumisel hakatakse jälgima 10-lt tunnile 20 tunnini jõudmist.
